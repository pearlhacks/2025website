      ...
      <div className="grid grid-cols-4 gap-4">
        {[...Array(4)].map((_, index) => (
          ...
          >
            ...
            <div className="animate-pulse h-3 bg-gray-200 rounded-md w-2/3"></div>
            <div className="animate-pulse h-3 bg-gray-200 rounded-md w-1/3"></div>
            <div className="animate-pulse h-3 bg-gray-200 rounded-md w-3/5"></div>
          </div>
        ))}
      </div>
    </div>
