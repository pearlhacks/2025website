              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="bg-white rounded-3xl border-4 border-brown-light p-8 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-brown mb-2">General Track</h3>
                    </div>
                  </div>
                  ...
                  <details className="mt-6">
                    <summary className="cursor-pointer text-brown font-semibold hover:text-brown-light flex items-center">
                      Rules & Eligibility
                ...
                <div className="bg-white rounded-3xl border-4 border-brown-light p-8 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-brown mb-2">Beginner Track</h3>
                    </div>
                  </div>
                  <p className="text-brown leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="bg-white rounded-3xl border-4 border-blue-light p-8 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-brown mb-2">UX/UI Focus Pathway</h3>
                    </div>
                  </div>
                  <p className="text-brown leading-relaxed">
                ...
                <div className="bg-white rounded-3xl border-4 border-blue-light p-8 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-brown mb-2">AI Focus Pathway</h3>
                    </div>
                  </div>
                  <p className="text-brown leading-relaxed">
